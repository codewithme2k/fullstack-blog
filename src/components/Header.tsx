  ...
  return (
    ...
    >
      <Link href="/" className="flex items-center gap-2 lg:hidden">
        ...
        <span className="text-lg font-bold hidden lg:block">MADE</span>
      </Link>
      <div className="rounded-full gap-1 h-10 px-5 bgDarkMode w-[min(100%,390px)] items-center flex borderDarkMode">
        <input
          type="text"
          placeholder="Search..."
